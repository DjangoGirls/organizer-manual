...
A única forma que você pode mensurar o compromisso de alguém é através do seu formulário de inscrição. Certifique-se de que ele contém as perguntas que lhe darão as dicas necessárias sobre a pessoa.
...
Se você não planeja prover qualquer assistência financeira para os participantes, você deve abrir um processo de inscrição com pelo menos um mês (idealmente dois) de antecedência ao evento. Dê as pessoas duas semanas para inscreverem-se e explicar por que elas devem ser as selecionadas para participar do evento e quais são as suas motivações. Você pode criar um simples formulário no Google Doc ou usar algum serviço gratuito como o Wufoo. Envie os emails de aceitação/rejeição uma semana antes do evento. Certifique-se da confirmação de que eles irão comparecer.
